...
import '../Children.css';
// import { renseignements$ } from './Child-rxjs';
import { addRenseignement } from './Child-rxjs';
...
export const AddChild = () =>{
    ...
    const [RenseignementInsuranceName, setNameInsu] = useState('');
    const [RenseignementInsuranceAddress, setAddressInsu] = useState('');
    ...
    const [RenseignementTierceName, setTiercePersonneName] = useState();
    const [RenseignementTiercePhone, setTiercePersonnePhone] = useState();
    const [RenseignementTierceAddress, setTiercePersonneAddress] = useState();
    const [RenseignementTierce2Name, setTiercePersonne2Name] = useState();
    const [RenseignementTierce2Phone, setTiercePersonne2Phone] = useState();
    const [RenseignementTierce2Address, setTiercePersonne2Address] = useState();
    ...
    return(
        ...
        <span className='span-btn'>
            <input className='btn btn-prev' type="submit" value='Précédent' onClick={handlePrev} />
            <input className='btn btn-next' type="submit" value='Suivant' onClick={handleNext}/>
